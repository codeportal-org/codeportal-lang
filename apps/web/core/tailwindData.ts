  ...
  for (const tailwindStyle of tailwindData) {
    ...
    if (tailwindStyle.useScale) {
      for (const value of tailwindScale) {
        const item: TailwindClassDataItem = {
          className: `${tailwindStyle.tag}-${value.name}`,
          args: [value],
          data: tailwindStyle,
        }
...
export const tailwindScale: TailwindScale[] = [
  ...
  { name: "px", size: "1px", pixels: 1 },
  { name: "0.5", size: "0.125rem", pixels: 2 },
...
export const tailwindFractions: TailwindScale[] = [
  { name: "1/2", size: "50%" },
  { name: "1/3", size: "33.333333%" },
  { name: "2/3", size: "66.666667%" },
  { name: "1/4", size: "25%" },
  { name: "2/4", size: "50%" },
  { name: "3/4", size: "75%" },
  { name: "1/5", size: "20%" },
  ...
  { name: "3/5", size: "60%" },
  { name: "4/5", size: "80%" },
  { name: "1/6", size: "16.666667%" },
  { name: "2/6", size: "33.333333%" },
  { name: "3/6", size: "50%" },
  { name: "4/6", size: "66.666667%" },
  { name: "5/6", size: "83.333333%" },
  { name: "1/12", size: "8.333333%" },
  { name: "2/12", size: "16.666667%" },
  { name: "3/12", size: "25%" },
  { name: "4/12", size: "33.333333%" },
  { name: "5/12", size: "41.666667%" },
  { name: "6/12", size: "50%" },
  { name: "7/12", size: "58.333333%" },
  { name: "8/12", size: "66.666667%" },
  { name: "9/12", size: "75%" },
  { name: "10/12", size: "83.333333%" },
  { name: "11/12", size: "91.666667%" },
]
...
export const tailwindData: TailwindClassData[] = [
  ...
  /* Border Radius */
  {
    ...
    title: "Border Radius",
    type: "borders",
    description: "Border radius on all sides.",
    docsUrl: "https://tailwindcss.com/docs/border-radius",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
  },
  {
    name: "border radius start",
    tag: "rounded-s",
    title: "Border Radius Start",
    type: "borders",
    description: "Border radius left in LTR, right in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-radius",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
  ...
  {
    name: "border radius end",
    tag: "rounded-e",
    title: "Border Radius End",
    type: "borders",
    description: "Border radius right in LTR, left in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-radius",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
  ...
  // logical properties
  {
    name: "border radius start start",
    tag: "rounded-ss",
    title: "Border Radius Start Start",
    type: "borders",
    description: "Border top left radius in LTR, top right in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-radius#using-logical-properties",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
  },
  {
    name: "border radius start end",
    tag: "rounded-se",
    title: "Border Radius Start End",
    type: "borders",
    description: "Border top right radius in LTR, top left in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-radius#using-logical-properties",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
  ...
  {
    name: "border radius end end",
    tag: "rounded-ee",
    title: "Border Radius End End",
    type: "borders",
    description: "Border bottom right radius in LTR, bottom left in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-radius#using-logical-properties",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
  ...
  {
    name: "border radius end start",
    tag: "rounded-es",
    title: "Border Radius End Start",
    type: "borders",
    description: "Border bottom left radius in LTR, bottom right in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-radius#using-logical-properties",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
...

  {
    ...
    tag: "rounded-tl",
    title: "Border Radius Top Left",
    type: "borders",
    description: "Border top left radius.",
    docsUrl: "https://tailwindcss.com/docs/border-radius#rounding-corners-separately",
    values: ["none", "sm", "md", "lg", "xl", "2xl", "3xl", "full"],
    isStandalone: true,
    allowArbitraryValues: true,
  },
...

  {
    ...
    tag: "rounded-br",
    title: "Border Radius Bottom Right",
    type: "borders",
  ...
  },
  {
    ...
    tag: "rounded-bl",
    title: "Border Radius Bottom Left",
    type: "borders",
  ...
  /* Border Width */
  {
    ...
    title: "Border Width",
    type: "borders",
    description: "Border width for all sides.",
    docsUrl: "https://tailwindcss.com/docs/border-width",
    values: ["0", "2", "4", "8"],
    isStandalone: true,
    allowArbitraryValues: true,
  },
  {
    name: "border width x",
    tag: "border-x",
    title: "Border Width X",
    type: "borders",
    description: "Border width for left and right sides.",
    docsUrl: "https://tailwindcss.com/docs/border-width",
    values: ["0", "2", "4", "8"],
    isStandalone: true,
    allowArbitraryValues: true,
  },
  {
    name: "border width y",
    tag: "border-y",
    title: "Border Width Y",
    type: "borders",
    description: "Border width for top and bottom sides.",
    docsUrl: "https://tailwindcss.com/docs/border-width",
    values: ["0", "2", "4", "8"],
    isStandalone: true,
    allowArbitraryValues: true,
  ...
  {
    name: "border width start",
    tag: "border-s",
    title: "Border Width Start",
    type: "borders",
    description: "Border width for start side in LTR, left side in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-width",
    values: ["0", "2", "4", "8"],
    isStandalone: true,
    allowArbitraryValues: true,
  ...
  {
    name: "border width end",
    tag: "border-e",
    title: "Border Width End",
    type: "borders",
    description: "Border width for end side in LTR, right side in RTL.",
    docsUrl: "https://tailwindcss.com/docs/border-width",
    values: ["0", "2", "4", "8"],
    isStandalone: true,
    allowArbitraryValues: true,
